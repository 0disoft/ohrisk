...
function renderTopLevelHelp(): string {
  return [
    ...
    "",
    "Usage:",
    "  ohrisk scan [--lockfile <path>] [--workspace-root <path>] [--profile saas|distributed-app] [--prod] [--no-waivers] [--json|--sarif|--markdown|--html|--cyclonedx] [--language en|ko|es|fr] [--output <file>] [--open]",
    "  ohrisk ci [--lockfile <path>] [--workspace-root <path>] [--profile saas|distributed-app] [--prod] [--no-waivers] [--json|--sarif|--markdown|--html|--cyclonedx] [--language en|ko|es|fr] [--fail-on high|unknown|review|low] [--strict-waivers] [--output <file>] [--open]",
    ...
    "  --language <en|ko|es|fr> Set the HTML report language. Defaults to en.",
