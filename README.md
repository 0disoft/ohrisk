...
- remote HTTP(S) package tarball evidence when the lockfile points to a tarball, with obvious local, private, special-purpose, and DNS-resolved internal hosts blocked before fetch and redirects left unfollowed
