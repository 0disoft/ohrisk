...
- SPDX-like license expression parsing against the pinned official license and exception catalog, including local and external-document `LicenseRef` syntax that remains custom low-confidence evidence
