...
- remote HTTP(S) package tarball evidence when the lockfile points to a tarball, with obvious local/private network hosts and DNS answers blocked before fetch and redirects left unfollowed
