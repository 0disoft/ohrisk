...
- remote HTTP(S) package tarball evidence when the lockfile points to a tarball, with obvious local and private network hosts blocked before fetch and redirects left unfollowed
