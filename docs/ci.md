...
version tag when reproducible CI matters; `0disoft/ohrisk@v1.1.0` installs
`ohrisk@1.1.0` by default.
...
Only `latest` and semantic versions such as `1.1.0` or `v1.1.0` are accepted.
