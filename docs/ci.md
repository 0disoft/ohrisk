...
version tag when reproducible CI matters; `0disoft/ohrisk@v1.1.1` installs
`ohrisk@1.1.1` by default.
...
Only `latest` and semantic versions such as `1.1.1` or `v1.1.1` are accepted.
