...
version tag when reproducible CI matters; `0disoft/ohrisk@v1.0.4` installs
`ohrisk@1.0.4` by default.
...
Only `latest` and semantic versions such as `1.0.4` or `v1.0.4` are accepted.
