...
CycloneDX is an SBOM, not a risk report. It focuses on component inventory with license and active finding properties. For waiver details, use JSON, Markdown, or SARIF output.
